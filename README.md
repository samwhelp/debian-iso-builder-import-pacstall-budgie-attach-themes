...
> [debian-iso-builder-import-pacstall-budgie-attach-themes](https://samwhelp.github.io/debian-iso-builder-import-pacstall-budgie-attach-themes/)
...
| Config |
| ------ |
| [~/.config](https://github.com/samwhelp/debian-iso-builder-import-pacstall-budgie-attach-themes/tree/main/profile/template/asset/overlay/etc/skel/.config) |
| [/usr/share/glib-2.0/schemas](https://github.com/samwhelp/debian-iso-builder-import-pacstall-budgie-attach-themes/tree/main/profile/template/asset/overlay/usr/share/glib-2.0/schemas) |
| [/etc/dconf/db/distro.d](https://github.com/samwhelp/debian-iso-builder-import-pacstall-budgie-attach-themes/tree/main/profile/template/asset/overlay/etc/dconf/db/distro.d) |
...
> clone [debian-iso-builder-import-pacstall-budgie-attach-themes](https://github.com/samwhelp/debian-iso-builder-import-pacstall-budgie-attach-themes)

``` sh
git clone https://github.com/samwhelp/debian-iso-builder-import-pacstall-budgie-attach-themes.git
```


> change dir to `debian-iso-builder-import-pacstall-budgie-attach-themes`

``` sh
cd debian-iso-builder-import-pacstall-budgie-attach-themes
```
...
> change dir to `~/work/debian-iso-builder-import-pacstall-budgie-attach-themes/iso-profile`

``` sh
cd ~/work/debian-iso-builder-import-pacstall-budgie-attach-themes/iso-profile
```
...
> The resulting ISO file will be placed on `~/work/debian-iso-builder-import-pacstall-budgie-attach-themes/iso-profile/dist`
